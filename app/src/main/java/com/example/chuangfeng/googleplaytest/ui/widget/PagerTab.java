...
import com.example.chuangfeng.googleplaytest.ui.activity.BaseActivity;
import com.example.chuangfeng.googleplaytest.utils.UIUtils;

/**
 * 1. 创建BaseActivity, 继承ActionBarActivity(解决support-v4冲突)
 * 2. 创建状态选择器: drawable/bg_tab_text.xml, color/tab_text_color.xml
 * 3. UIUtils增加方法:getColorStateList, 加载颜色的状态选择器对象
 * @author Kevin
 * @date 2015-9-24
 */
